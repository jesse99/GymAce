...
struct EnumerateTests {
    ...
    func enumerate3() {
        ...
        #expect(v[2].plates == [Plate(45.0, 1), Plate(25.0, 1)])
    }
...
//        print("\(v)")
        ...
        #expect(v[0].plates == [Plate(25.0, 1)])
        #expect(v[1].plates == [Plate(45.0, 1)])
        #expect(v[2].plates == [Plate(25.0, 2)])
        #expect(v[3].plates == [Plate(45.0, 1), Plate(25.0, 1)])
        #expect(v[4].plates == [Plate(45.0, 1), Plate(25.0, 2)])
    }
    ...
    func enumerate5() {
        ...
        #expect(v[2].plates == [Plate(25.0, 2)])
        #expect(v[3].plates == [Plate(45.0, 1), Plate(25.0, 1)])
        #expect(v[4].plates == [Plate(45.0, 2)])
        #expect(v[5].plates == [Plate(45.0, 1), Plate(25.0, 2)])
        #expect(v[6].plates == [Plate(45.0, 2), Plate(25.0, 1)])
        #expect(v[7].plates == [Plate(45.0, 2), Plate(25.0, 2)])
    }
