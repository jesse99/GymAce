...
//            if case .single(var w) = ws {
//                if !w.plates.contains(where: {Int(1000*$0.weight) == Int(1000*weight)}) {
//                    w.plates.append(p)
//                    w.plates.sort(by: >)
//                    model.weightSets[name] = .single(w)
//                }
//            } else if case .dual(var w) = ws {
//                if !w.plates.contains(where: {Int(1000*$0.weight) == Int(1000*weight)}) {
//                    w.plates.append(p)
//                    w.plates.sort(by: >)
//                    model.weightSets[name] = .dual(w)
//                }
//            }
//
